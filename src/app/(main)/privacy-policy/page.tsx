      ...
      >
        ...
        <Paper sx={{ p: 4, mb: 4 }}>
          ...
          <Typography component="ul" sx={{ pl: 4 }}>
            ...
            <li>
              <Typography paragraph>
                <strong>Application</strong> refers to Zen Analytics Pixel Tracker, the software program provided by the Company.
              </Typography>
            </li>
            <li>
              <Typography paragraph>
                <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Zen Analytics, Vietnam.
              </Typography>
            </li>
            <li>
              <Typography paragraph>
